...
SEMCONV_DOC_LINKS: dict[str, str] = {
    ...
    "inference": "../../docs/gen-ai/inference.md#span-gen_aiclientinference",
    ...
    "gen_ai.client.inference.operation.details": "../../docs/gen-ai/inference.md#event-gen_aiclientinferenceoperationdetails",
    ...
    "gen_ai.client.inference.duration": "../../docs/gen-ai/inference.md#metric-gen_aiclientinferenceduration",
