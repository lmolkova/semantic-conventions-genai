...
SEMCONV_DOC_LINKS: dict[str, str] = {
    ...
    "gen_ai.client.inference.usage.operation.input_tokens": "../../docs/gen-ai/gen-ai-inference-usage-metrics.md#metric-gen_aiclientinferenceusageoperationinput_tokens",
    "gen_ai.client.inference.usage.operation.output_tokens": "../../docs/gen-ai/gen-ai-inference-usage-metrics.md#metric-gen_aiclientinferenceusageoperationoutput_tokens",
    ...
    "gen_ai.client.inference.usage.cache_read.input_tokens": "../../docs/gen-ai/gen-ai-inference-usage-metrics.md#metric-gen_aiclientinferenceusagecache_readinput_tokens",
    "gen_ai.client.inference.usage.cache_write.input_tokens": "../../docs/gen-ai/gen-ai-inference-usage-metrics.md#metric-gen_aiclientinferenceusagecache_writeinput_tokens",
    "gen_ai.client.inference.usage.reasoning.output_tokens": "../../docs/gen-ai/gen-ai-inference-usage-metrics.md#metric-gen_aiclientinferenceusagereasoningoutput_tokens",
