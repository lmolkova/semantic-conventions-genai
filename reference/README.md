...
| [Invoke Agent Internal](reports/invoke-agent-internal-span.md) | a2a, agent-framework, autogen, crewai, google-adk, openai-agents, pydantic-ai |
...
| [Execute Tool](reports/execute-tool-span.md) | a2a, agent-framework, autogen, crewai, google-adk, groq, instructor, litellm, llamaindex, mistralai, openai, openai-agents, openai-assistants, pydantic-ai |
...
| Entity | Libraries |
| --- | --- |
| [Main Agent](reports/gen-ai-main-agent-entity.md) | a2a |
<!-- status:end -->
