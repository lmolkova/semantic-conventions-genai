...
| Metric | Libraries |
| --- | --- |
| [Client Inference Operation Input Tokens](reports/gen-ai-client-inference-usage-operation-input-tokens-metric.md) | anthropic, google-genai, openai |
| [Client Inference Operation Output Tokens](reports/gen-ai-client-inference-usage-operation-output-tokens-metric.md) | anthropic, google-genai, openai |
