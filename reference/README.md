...
| Metric | Libraries |
| --- | --- |
| [Client Inference Operation Input Tokens](reports/gen-ai-client-inference-usage-operation-input-tokens-metric.md) | anthropic, openai |
| [Client Inference Operation Output Tokens](reports/gen-ai-client-inference-usage-operation-output-tokens-metric.md) | anthropic, openai |
| [Client Inference Input Tokens](reports/gen-ai-client-inference-usage-input-tokens-metric.md) | anthropic, openai |
| [Client Inference Output Tokens](reports/gen-ai-client-inference-usage-output-tokens-metric.md) | anthropic, openai |
| [Client Inference Cache Read Input Tokens](reports/gen-ai-client-inference-usage-cache-read-input-tokens-metric.md) | anthropic, openai |
