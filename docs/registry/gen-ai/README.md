...
## [Spans](/docs/registry/gen-ai/spans.md)

| Type | Stability | Description |
| --- | --- | --- |
| [`gen_ai.create_agent.client`](/docs/registry/gen-ai/spans.md#gen-ai-create-agent-client) | ![Development](https://img.shields.io/badge/-development-blue) | Describes GenAI agent creation and is usually applicable when working with remote agent services. |
| [`gen_ai.embeddings.client`](/docs/registry/gen-ai/spans.md#gen-ai-embeddings-client) | ![Development](https://img.shields.io/badge/-development-blue) | Describes GenAI embeddings span - a request to a Generative AI model or service that generates an embeddings based on the input. |
| [`gen_ai.execute_tool.internal`](/docs/registry/gen-ai/spans.md#gen-ai-execute-tool-internal) | ![Development](https://img.shields.io/badge/-development-blue) | Describes tool execution span. |
| [`gen_ai.inference.client`](/docs/registry/gen-ai/spans.md#gen-ai-inference-client) | ![Development](https://img.shields.io/badge/-development-blue) | This span represents a client call to Generative AI model or service that generates a response or requests a tool call based on the input prompt. |
| [`gen_ai.invoke_agent.client`](/docs/registry/gen-ai/spans.md#gen-ai-invoke-agent-client) | ![Development](https://img.shields.io/badge/-development-blue) | Describes GenAI agent invocation over a remote service. |
| [`gen_ai.invoke_agent.internal`](/docs/registry/gen-ai/spans.md#gen-ai-invoke-agent-internal) | ![Development](https://img.shields.io/badge/-development-blue) | Describes GenAI agent invocation within the same process. |
| [`gen_ai.invoke_workflow.internal`](/docs/registry/gen-ai/spans.md#gen-ai-invoke-workflow-internal) | ![Development](https://img.shields.io/badge/-development-blue) | Represents an operation that executes a coordinated process composed of multiple agents or other operations involving generative AI. |
| [`gen_ai.memory.client`](/docs/registry/gen-ai/spans.md#gen-ai-memory-client) | ![Development](https://img.shields.io/badge/-development-blue) | Describes a memory operation, including memory store lifecycle operations and memory record operations. |
| [`gen_ai.plan.internal`](/docs/registry/gen-ai/spans.md#gen-ai-plan-internal) | ![Development](https://img.shields.io/badge/-development-blue) | Represents an agent planning or task decomposition phase. |
| [`gen_ai.retrieval.client`](/docs/registry/gen-ai/spans.md#gen-ai-retrieval-client) | ![Development](https://img.shields.io/badge/-development-blue) | Describes GenAI retrieval span - a request to a Generative AI service or framework that retrieves relevant information or context from a vector database or search system. |

## [Metrics](/docs/registry/gen-ai/metrics.md)

| Name | Stability | Description |
| --- | --- | --- |
| [`gen_ai.client.operation.duration`](/docs/registry/gen-ai/metrics.md#gen-ai-client-operation-duration) | ![Development](https://img.shields.io/badge/-development-blue) | GenAI operation duration. |
| [`gen_ai.client.operation.time_per_output_chunk`](/docs/registry/gen-ai/metrics.md#gen-ai-client-operation-time-per-output-chunk) | ![Development](https://img.shields.io/badge/-development-blue) | Time per output chunk, recorded for each chunk received after the first one, measured as the time elapsed from the end of the previous chunk to the end of the current chunk. |
| [`gen_ai.client.operation.time_to_first_chunk`](/docs/registry/gen-ai/metrics.md#gen-ai-client-operation-time-to-first-chunk) | ![Development](https://img.shields.io/badge/-development-blue) | Time to receive the first chunk, measured from when the client issues the generation request to when the first chunk is received in the response stream. |
| [`gen_ai.client.token.usage`](/docs/registry/gen-ai/metrics.md#gen-ai-client-token-usage) | ![Development](https://img.shields.io/badge/-development-blue) | Number of input and output tokens used. |
| [`gen_ai.execute_tool.duration`](/docs/registry/gen-ai/metrics.md#gen-ai-execute-tool-duration) | ![Development](https://img.shields.io/badge/-development-blue) | The duration of a single tool execution. |
| [`gen_ai.invoke_agent.duration`](/docs/registry/gen-ai/metrics.md#gen-ai-invoke-agent-duration) | ![Development](https://img.shields.io/badge/-development-blue) | The end-to-end duration of a single in-process agent invocation, from the moment the invocation starts until the agent emits the last chunk of its final response or terminates with an error. |
| [`gen_ai.server.request.duration`](/docs/registry/gen-ai/metrics.md#gen-ai-server-request-duration) | ![Development](https://img.shields.io/badge/-development-blue) | Generative AI server request duration such as time-to-last byte or last output token. |
| [`gen_ai.server.time_per_output_token`](/docs/registry/gen-ai/metrics.md#gen-ai-server-time-per-output-token) | ![Development](https://img.shields.io/badge/-development-blue) | Time per output token generated after the first token for successful responses. |
| [`gen_ai.server.time_to_first_token`](/docs/registry/gen-ai/metrics.md#gen-ai-server-time-to-first-token) | ![Development](https://img.shields.io/badge/-development-blue) | Time to generate first token for successful responses. |
| [`gen_ai.workflow.duration`](/docs/registry/gen-ai/metrics.md#gen-ai-workflow-duration) | ![Development](https://img.shields.io/badge/-development-blue) | GenAI workflow duration. |

## [Events](/docs/registry/gen-ai/events.md)

| Name | Stability | Description |
| --- | --- | --- |
| [`gen_ai.client.inference.operation.details`](/docs/registry/gen-ai/events.md#gen-ai-client-inference-operation-details) | ![Development](https://img.shields.io/badge/-development-blue) | Describes the details of a GenAI completion request including chat history and parameters. |
| [`gen_ai.client.operation.exception`](/docs/registry/gen-ai/events.md#gen-ai-client-operation-exception) | ![Development](https://img.shields.io/badge/-development-blue) | This event represents an exception that occurred during a Generative AI client operation, such as API errors, rate limiting, model errors, timeouts, or other errors that prevent the operation from completing successfully. |
| [`gen_ai.evaluation.result`](/docs/registry/gen-ai/events.md#gen-ai-evaluation-result) | ![Development](https://img.shields.io/badge/-development-blue) | This event captures the result of evaluating GenAI output for quality, accuracy, or other characteristics. This event SHOULD be parented to GenAI operation span being evaluated when possible or set `gen_ai.response.id` when span id is not available. |
...
| <a id="gen-ai-retrieval-documents" href="#gen-ai-retrieval-documents">`gen_ai.retrieval.documents`</a> | ![Development](https://img.shields.io/badge/-development-blue) | any | The documents retrieved. [19] | <pre>[<br>  {<br>    "id": "doc_123",<br>    "score": 0.95<br>  },<br>  {<br>    "id": "doc_456",<br>    "score": 0.87<br>  },<br>  {<br>    "id": "doc_789",<br>    "score": 0.82<br>  }<br>]</pre> |
...
| <a id="gen-ai-tool-call-arguments" href="#gen-ai-tool-call-arguments">`gen_ai.tool.call.arguments`</a> | ![Development](https://img.shields.io/badge/-development-blue) | any | Parameters passed to the tool call. [22] | <pre>{<br>    "location": "San Francisco?",<br>    "date": "2025-10-01"<br>}</pre> |
...
| <a id="gen-ai-tool-call-result" href="#gen-ai-tool-call-result">`gen_ai.tool.call.result`</a> | ![Development](https://img.shields.io/badge/-development-blue) | any | The result returned by the tool call (if any and if execution was successful). [23] | <pre>{<br>  "temperature_range": {<br>    "high": 75,<br>    "low": 60<br>  },<br>  "conditions": "sunny"<br>}</pre> |
