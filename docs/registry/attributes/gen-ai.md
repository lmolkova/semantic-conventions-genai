...
| <a id="gen-ai-skill-description" href="#gen-ai-skill-description">`gen_ai.skill.description`</a> | ![Development](https://img.shields.io/badge/-development-blue) | string | The description of the skill associated with the tool execution. [26] | `Review code using the team's review policy.` |
| <a id="gen-ai-skill-name" href="#gen-ai-skill-name">`gen_ai.skill.name`</a> | ![Development](https://img.shields.io/badge/-development-blue) | string | The name of the skill associated with the tool execution. [27] | `data-analysis` |
| <a id="gen-ai-skill-resource-name" href="#gen-ai-skill-resource-name">`gen_ai.skill.resource.name`</a> | ![Development](https://img.shields.io/badge/-development-blue) | string | The skill-relative name of the resource accessed or executed by the tool. [28] | `scripts/analyze.py`; `references/schema.md` |
| <a id="gen-ai-skill-source-uri" href="#gen-ai-skill-source-uri">`gen_ai.skill.source.uri`</a> | ![Development](https://img.shields.io/badge/-development-blue) | string | The URI of the source from which the skill definition was loaded. [29] | `file:///opt/skills/code-review`; `gs://example-skills/code-review`; `https://skills.example.com/code-review.zip` |
...
**[27] `gen_ai.skill.name`:** Instrumentations SHOULD obtain the association from tool call arguments,
the tool definition, or instrumented library state.

**[28] `gen_ai.skill.resource.name`:** This attribute records the logical, skill-relative resource name available
...
**[29] `gen_ai.skill.source.uri`:** Instrumentations SHOULD record the original URI available to the skill loader
