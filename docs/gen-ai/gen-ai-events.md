...
| [`gen_ai.evaluation.score.label`](/docs/registry/gen-ai/README.md#gen-ai-evaluation-score-label) | ![Development](https://img.shields.io/badge/-development-blue) | `Conditionally Required` If applicable. | string | Human readable label for evaluation. [2] | `relevant`; `not_relevant`; `correct`; `incorrect`; `pass`; `fail` |
...
| [`gen_ai.response.id`](/docs/registry/gen-ai/README.md#gen-ai-response-id) | ![Development](https://img.shields.io/badge/-development-blue) | `Recommended` When available. | string | The unique identifier for the completion. [3] | `chatcmpl-123` |
