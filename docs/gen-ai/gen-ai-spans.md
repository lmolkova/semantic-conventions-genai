...
**Span name** SHOULD be `execute_tool {gen_ai.tool.name}` and may be adjusted for well-known tools.
...
| [`gen_ai.skill.name`](/docs/registry/attributes/gen-ai.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Conditionally Required` [3] | string | The name of the skill associated with the tool execution. [4] | `data-analysis` |
| [`gen_ai.skill.resource.name`](/docs/registry/attributes/gen-ai.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Conditionally Required` [5] | string | The skill-relative name of the resource accessed or executed by the tool. [6] | `scripts/analyze.py`; `references/schema.md` |
| [`gen_ai.skill.description`](/docs/registry/attributes/gen-ai.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Recommended` [7] | string | The description of the skill associated with the tool execution. [8] | `Review code using the team's review policy.` |
| [`gen_ai.skill.source.uri`](/docs/registry/attributes/gen-ai.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Recommended` [9] | string | The URI of the source from which the skill definition was loaded. [10] | `file:///opt/skills/code-review`; `gs://example-skills/code-review`; `https://skills.example.com/code-review.zip` |
...
**[3] `gen_ai.skill.name`:** If the execution is associated with a skill and its name is available.

**[4] `gen_ai.skill.name`:** Instrumentations SHOULD obtain the association from tool call arguments,
the tool definition, or instrumented library state.

**[5] `gen_ai.skill.resource.name`:** If the tool accesses or executes a named skill resource and the name is available.

**[6] `gen_ai.skill.resource.name`:** This attribute records the logical, skill-relative resource name available
...
**[7] `gen_ai.skill.description`:** If the execution resolves to a skill and its description is available.
...
**[9] `gen_ai.skill.source.uri`:** If the execution resolves to a skill and its source URI is available.

**[10] `gen_ai.skill.source.uri`:** Instrumentations SHOULD record the original URI available to the skill loader
and MUST NOT replace it with a temporary or cache location.
...
| [`error.type`](https://github.com/open-telemetry/semantic-conventions/blob/v1.44.0/docs/registry/attributes/error.md) | ![Stable](https://img.shields.io/badge/-stable-lightgreen) | `Conditionally Required` If the operation ended in an error. | string | Describes a class of error the operation ended with. [2] | `timeout`; `java.net.UnknownHostException`; `server_certificate_invalid`; `500` |
| [`gen_ai.agent.name`](/docs/registry/attributes/gen-ai.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Conditionally Required` When applicable. | string | The human-readable name of the agent executing the tool. | `Math Tutor`; `Fiction Writer` |
| [`gen_ai.skill.name`](/docs/registry/attributes/gen-ai.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Conditionally Required` If the skill name is available. | string | The name of the skill associated with the tool execution. [3] | `data-analysis` |
| [`gen_ai.skill.resource.name`](/docs/registry/attributes/gen-ai.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Conditionally Required` [4] | string | The skill-relative name of the resource accessed or executed by the tool. [5] | `scripts/analyze.py`; `references/schema.md` |
| [`gen_ai.skill.description`](/docs/registry/attributes/gen-ai.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Recommended` If the skill description is available. | string | The description of the skill associated with the tool execution. [6] | `Review code using the team's review policy.` |
| [`gen_ai.skill.source.uri`](/docs/registry/attributes/gen-ai.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Recommended` If the skill source URI is available. | string | The URI of the source from which the skill definition was loaded. [7] | `file:///opt/skills/code-review`; `gs://example-skills/code-review`; `https://skills.example.com/code-review.zip` |
| [`gen_ai.tool.call.id`](/docs/registry/attributes/gen-ai.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Recommended` If available. | string | The tool call identifier. | `call_mszuSIzqtI65i1wAUOE8w5H4` |
...
**[4] `gen_ai.skill.resource.name`:** If the tool accesses or executes a named skill resource and the name is available.
...
**[7] `gen_ai.skill.source.uri`:** Instrumentations SHOULD record the original URI available to the skill loader
and MUST NOT replace it with a temporary or cache location.
Sensitive URI components, such as user information and access tokens in query
parameters, SHOULD be scrubbed when instrumentations can identify them.
...
- [Microsoft Agent Framework](https://learn.microsoft.com/agent-framework/agents/skills)
  `read_skill_resource`;
- [Agno](https://docs.agno.com/skills/overview) `get_skill_reference` and
  `get_skill_script` when called with `execute=false`.

**Span name** SHOULD be
`{gen_ai.tool.name} {gen_ai.skill.name} {gen_ai.skill.resource.name}`
when the skill and resource names are available. If the skill name and
executable name are available, it SHOULD be
`{gen_ai.tool.name} {gen_ai.skill.name} {process.executable.name}`.

Without a skill name, the resource name SHOULD be appended when available;
otherwise, the executable name SHOULD be appended when available. If none
are available, **span name** SHOULD be `{gen_ai.tool.name}`. The skill name
SHOULD NOT be appended by itself.
...
| [`gen_ai.agent.name`](/docs/registry/attributes/gen-ai.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Conditionally Required` When applicable. | string | The human-readable name of the agent executing the tool. | `Math Tutor`; `Fiction Writer` |
| [`gen_ai.skill.name`](/docs/registry/attributes/gen-ai.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Conditionally Required` If the skill name is available. | string | The name of the skill associated with the tool execution. [3] | `data-analysis` |
| [`gen_ai.skill.resource.name`](/docs/registry/attributes/gen-ai.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Conditionally Required` If the skill resource name is available. | string | The skill-relative name of the resource accessed or executed by the tool. [4] | `scripts/analyze.py`; `references/schema.md` |
| [`gen_ai.skill.description`](/docs/registry/attributes/gen-ai.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Recommended` If the skill description is available. | string | The description of the skill associated with the tool execution. [5] | `Review code using the team's review policy.` |
| [`gen_ai.skill.source.uri`](/docs/registry/attributes/gen-ai.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Recommended` If the skill source URI is available. | string | The URI of the source from which the skill definition was loaded. [6] | `file:///opt/skills/code-review`; `gs://example-skills/code-review`; `https://skills.example.com/code-review.zip` |
| [`gen_ai.tool.call.id`](/docs/registry/attributes/gen-ai.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Recommended` If available. | string | The tool call identifier. | `call_mszuSIzqtI65i1wAUOE8w5H4` |
...
**[4] `gen_ai.skill.resource.name`:** This attribute records the logical, skill-relative resource name available
from the tool call or instrumented library state, for example
`scripts/analyze.py` or `references/schema.md`.
...
**[6] `gen_ai.skill.source.uri`:** Instrumentations SHOULD record the original URI available to the skill loader
and MUST NOT replace it with a temporary or cache location.
Sensitive URI components, such as user information and access tokens in query
parameters, SHOULD be scrubbed when instrumentations can identify them.
...
This refinement applies when a tool represents command execution, whether or
not it is associated with a skill.
Examples include:
...
- [Strands Agents](https://strandsagents.com/docs/user-guide/concepts/plugins/skills/)
  `shell`, which is used for both general commands and bundled skill scripts;
...
The tool span covers framework processing
such as validation, skill resolution, approval, hooks, and result handling.

Instrumentations MAY also emit a child span following the
...
for each observed process execution.

**Span name** SHOULD be:

- `{gen_ai.tool.name} {gen_ai.skill.name} {gen_ai.skill.resource.name}`
when the skill and resource names are both available.
- `{gen_ai.tool.name} {gen_ai.skill.resource.name}`
when only the skill resource name is available. The skill name
SHOULD NOT be appended without the resource name.
- `{gen_ai.tool.name} {process.executable.name}`
when only the executable name is available.
- `{gen_ai.tool.name}` in all other cases.
...
| [`gen_ai.skill.description`](/docs/registry/attributes/gen-ai.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Recommended` [9] | string | The description of the skill associated with the tool execution. [10] | `Review code using the team's review policy.` |
| [`gen_ai.skill.source.uri`](/docs/registry/attributes/gen-ai.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Recommended` [11] | string | The URI of the source from which the skill definition was loaded. [12] | `file:///opt/skills/code-review`; `gs://example-skills/code-review`; `https://skills.example.com/code-review.zip` |
| [`gen_ai.tool.call.id`](/docs/registry/attributes/gen-ai.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Recommended` If available. | string | The tool call identifier. | `call_mszuSIzqtI65i1wAUOE8w5H4` |
...
**[12] `gen_ai.skill.source.uri`:** Instrumentations SHOULD record the original URI available to the skill loader
and MUST NOT replace it with a temporary or cache location.
Sensitive URI components, such as user information and access tokens in query
parameters, SHOULD be scrubbed when instrumentations can identify them.
