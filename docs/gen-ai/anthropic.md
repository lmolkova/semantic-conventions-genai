...
| [`gen_ai.usage.tool.input_tokens`](/docs/registry/attributes/gen-ai.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Recommended` | int | The number of input tokens from tool results that are provided back to as input. [31] | `30` |
