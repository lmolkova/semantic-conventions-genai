...
<!-- weaver .registry.metrics[] | select(.name == "gen_ai.client.inference.usage.operation.input_tokens") -->
...
| -------- | --------------- | ----------- | -------------- | --------- | ------ |
| `gen_ai.client.inference.usage.operation.input_tokens` | Histogram | `{token}` | The number of input (prompt) tokens used per inference operation. [1] | ![Development](https://img.shields.io/badge/-development-blue) | |
...
<!-- weaver .registry.metrics[] | select(.name == "gen_ai.client.inference.usage.operation.output_tokens") -->
<!-- NOTE: THIS TEXT IS AUTOGENERATED. DO NOT EDIT BY HAND. -->
<!-- see templates/registry/markdown/snippet.md.j2 -->
<!-- prettier-ignore-start -->
...
| Name | Instrument Type | Unit (UCUM) | Description | Stability | Entity Associations |
| -------- | --------------- | ----------- | -------------- | --------- | ------ |
| `gen_ai.client.inference.usage.operation.output_tokens` | Histogram | `{token}` | The number of output (completion) tokens used per inference operation. [1] | ![Development](https://img.shields.io/badge/-development-blue) | |
...
<!-- weaver .registry.metrics[] | select(.name == "gen_ai.client.inference.usage.operation.total_tokens") -->
<!-- NOTE: THIS TEXT IS AUTOGENERATED. DO NOT EDIT BY HAND. -->
<!-- see templates/registry/markdown/snippet.md.j2 -->
<!-- prettier-ignore-start -->
...
| Name | Instrument Type | Unit (UCUM) | Description | Stability | Entity Associations |
| -------- | --------------- | ----------- | -------------- | --------- | ------ |
| `gen_ai.client.inference.usage.operation.total_tokens` | Histogram | `{token}` | The total number of input and output tokens used per inference operation. [1] | ![Development](https://img.shields.io/badge/-development-blue) | |
