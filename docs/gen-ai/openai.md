...
Measures the duration to complete an inference operation following the common [gen_ai.client.inference.duration](./inference.md#metric-gen_aiclientinferenceduration) definition.
